...
struct ContentView: View {
    ...
    @State private var editingEntry: CarwashEntry?
    ...
    private var emptyState: some View {
        VStack(spacing: 12) {
            ...
            Text("No entries yet")
                ...
                .foregroundStyle(Theme.textPrimary)
            Text("Track how much you spend keeping your car clean over the year.")
                .font(Theme.captionFont)
                .foregroundStyle(Theme.textSecondary)
    ...
    private func row(for entry: CarwashEntry) -> some View {
        HStack {
...
struct EntryEditView: View {
    ...
    var onSave: (CarwashEntry) -> Void

    private let existingID: UUID?

    init(store: Store, existing: CarwashEntry? = nil, onSave: @escaping (CarwashEntry) -> Void) {
        self.store = store
        self.onSave = onSave
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        ...
                        let entry = CarwashEntry(id: existingID ?? UUID(), title: title.isEmpty ? "Untitled" : title, amount: amount, date: date, note: note)
                        onSave(entry)
                        dismiss()
                    }
